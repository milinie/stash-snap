...
const SAMPLE_STASH = [
  ...
  {
    id: 3,
    name: "Honey Geometric",
    color: "Honey",
    style: "Geometric",
    yardage: 3,
    collection: "Fat Quarters",
    notes: "Lori Holt style",
    photo: null,
    date: "Apr 15",
  },
  {
...
function FabricThumb({ color, style, photo, size = 72 }) {
  if (photo) {
    return (
      <img
        src={photo}
      ...
      {style === "Geometric" &&
        [0, 1, 2, 3].map((row) =>
          [0, 1, 2, 3].map((col) => (
            <polygon
              key={`${row}-${col}`}
              points={`${col * 12 + 6},${row * 12 + 2} ${
                col * 12 + 10
              },${row * 12 + 10} ${col * 12 + 2},${row * 12 + 10}`}
              fill="white"
              opacity="0.25"
            />
          ))
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "12px 14px", flex: 1 }}>
          ...
          >
            <strong style={{ fontSize: 12, color: PALETTE.teal }}>
              {item.yardage} yds
            </strong>
          ...
          <div style={{ display: "flex", gap: 4, marginTop: 6 }}>
            <span style={tagStyle(PALETTE.blush, PALETTE.rose)}>
              {item.color}
            </span>
            <span style={tagStyle(PALETTE.mist, PALETTE.teal)}>
              {item.style}
            </span>
          </div>
        </div>
...
export default function App() {
  ...
  const totalYards = useMemo(
    () => stash.reduce((sum, item) => sum + item.yardage, 0),
    [stash]
  );
  ...
  return (
    ...
    >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "sans-serif",
                fontWeight: 700,
                color: activeTab === id ? PALETTE.teal : "#bbb",
                borderBottom: `2px solid ${
                  activeTab === id ? PALETTE.teal : "transparent"
                }`,
              }}
            >
              {label}
      ...
      >
          ...
          <>
            ...
            >
              <button
                ...
                style={pillStyle(!filterStyle, PALETTE.teal)}
              >
                All
              </button>

              {["Floral", "Geometric", "Blender", "Vintage", "Solid"].map(
                (style) => (
                  <button
                    key={style}
                    onClick={() =>
                      setFilterStyle(filterStyle === style ? null : style)
                    }
                    style={pillStyle(filterStyle === style, PALETTE.rose)}
                  >
                    {style}
                  </button>
                )
        ...
        {activeTab === "bundles" && (
          <div>
            <h2 style={{ marginBottom: 6 }}>Bundle Match Engine 🎨</h2>
            <p style={{ color: "#999", fontFamily: "sans-serif" }}>
              See which fabrics in your stash work beautifully together.
            </p>
        ...
        {activeTab === "shop" && (
          <div>
            <h2>Shop Match 🛍</h2>
            <p style={{ color: "#999", fontFamily: "sans-serif" }}>
              Help customers complete their bundles from your shop.
            </p>
            ...
            >
              ...
              <p style={{ fontFamily: "sans-serif", color: "#777" }}>
                Based on your stash, you may only need a few more fabrics to
                finish your next quilt.
              </p>
